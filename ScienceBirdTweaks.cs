...
namespace ScienceBirdTweaks
{
    ...
    public class ScienceBirdTweaks : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            Red1Tip = base.Config.Bind("2. Ship Additions", "Fancy Panel Tooltips - Bottom Right Red", "", "If using fancy button panel, the tooltip for the bottom right red button (overriden by rotating floodlight).");
            Red2Tip = base.Config.Bind("2. Ship Additions", "Fancy Panel Tooltips - Middle Right Red", "", "If using fancy button panel, the tooltip for the smaller middle right red button.");
            Black1Tip = base.Config.Bind("2. Ship Additions", "Fancy Panel Tooltips - Bottom Middle Black", "", "If using fancy button panel, the tooltip for the bottom middle black button (overriden by floodlight configuration controls).");
            Black2Tip = base.Config.Bind("2. Ship Additions", "Fancy Panel Tooltips - Middle Right Black", "", "If using fancy button panel, the tooltip for the middle right black button (overriden by floodlight configuration controls).");
            Knob1Tip = base.Config.Bind("2. Ship Additions", "Fancy Panel Tooltips - Middle Right Knob", "", "If using fancy button panel, the tooltip for the middle right knob (overriden by floodlight configuration controls).");
            Knob2Tip = base.Config.Bind("2. Ship Additions", "Fancy Panel Tooltips - Top Middle Knob 1", "", "If using fancy button panel, the tooltip for the top middle knob closest to the player.");
            Knob3Tip = base.Config.Bind("2. Ship Additions", "Fancy Panel Tooltips - Top Middle Knob 2", "", "If using fancy button panel, the tooltip for the top middle knob farther from the player.");
            SmallKnobTip = base.Config.Bind("2. Ship Additions", "Fancy Panel Tooltips - Small Knob", "", "If using fancy button panel, the tooltip for the small knob at the top middle.");
            ...
            HandsFullFix = base.Config.Bind("3. General Tweaks", "Hands Full Tip Fix", true, "Fixes the misleading '[Hands full]' tip appearing even when you're able to interact with something with your hands full.");
            ...
            ClearOrphans = base.Config.Bind("Z. Technical", "Clear Orphaned Config On Next Join", false, "This check box acts like a button which will only activate once then go back to being unchecked: after starting a game, all unused config entries will be cleared. These are configs which are still in the config file, but you won't see them in your mod launcher (e.g. config entries that no longer exist in the current version or scrap bonus entries for interiors which are no longer installed)");
        ...
        internal static void Patch()
        {
            ...
            foreach (Assembly assembly in AppDomain.CurrentDomain.GetAssemblies())
            {
                ...
                else if (assembly.GetName().Name == "QualityCompanyFork")
                {
